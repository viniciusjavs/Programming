...
/*
  ...
  * It can be useful because with variables we have a bunch of memory at our
  disposal. But it can be a font a source of problems in a situation when we
