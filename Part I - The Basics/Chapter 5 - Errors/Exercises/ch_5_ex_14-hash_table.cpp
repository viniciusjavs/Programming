...
int main()
{
    cout << "Please enter (day-of-the-week, value) pairs: (Terminate with "
            "\"NoName 0\")\n";
    string day;
    int value;
    ...
    while (day != "NoName" || value != 0) {
        if (in_vector(day, sun)) sunday.push_back(value);
	else if (in_vector(day, mon)) monday.push_back(value);
	else if (in_vector(day, tue)) tuesday.push_back(value);
	else if (in_vector(day, wed)) wednesday.push_back(value);
	else if (in_vector(day, thu)) thursday.push_back(value);
	else if (in_vector(day, fri)) friday.push_back(value);
	else if (in_vector(day, sat)) saturday.push_back(value);
	else ++illegal_days;
	cin >> day >> value;
	if (!cin) error("Bad input");
    }
    cout << "The values of the seven day-of-the-week vectors followed by the "
            "sum of the values are:\n";
    cout << "Sunday: ";
    print_v(sunday);
    cout << "Sum: " << sum_v(sunday) << '\n';
    cout << "Monday: ";
    print_v(monday);
    cout << "Sum: " << sum_v(monday) << '\n';
    cout << "Tuesday: ";
    print_v(tuesday);
    cout << "Sum: " << sum_v(tuesday) << '\n';
    cout << "Wednesday: ";
    print_v(wednesday);
    cout << "Sum: " << sum_v(wednesday) << '\n';
    cout << "Thursday: ";
    print_v(thursday);
    cout << "Sum: " << sum_v(thursday) << '\n';
    cout << "Friday: ";
    print_v(friday);
    cout << "Sum: " << sum_v(friday) << '\n';
    cout << "Saturday: ";
    print_v(saturday);
    cout << "Sum: " << sum_v(saturday) << '\n';
